...
#ifndef YFEL_F1C100S_H
#define YFEL_F1C100S_H

#include "chip_type.h"
#include "fel.h"

class f1c100s : public Chips {
...
public:
    f1c100s(class fel *f, chip_version_t chip_version);

private:
    const dram_info_t f1c100s_dram_param = {
            .dram_param_name = "F1C100s Mainline DRAM Driver",
            .dram_param {
                    .dram_clk = 360,
                    .dram_type = 0,
                    .dram_zq = 0,
    ...
    constexpr static uint8_t dram_payload[] = {
