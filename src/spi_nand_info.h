...
enum spi_nand_ops_e {
    ...
    NAND_OPCODE_FEATURE_PROTECT = 0xa0,
    NAND_OPCODE_FEATURE_CONFIG = 0xb0,
    NAND_OPCODE_FEATURE_STATUS = 0xc0,
    NAND_OPCODE_READ_PAGE_TO_CACHE = 0x13,
    NAND_OPCODE_READ_PAGE_FROM_CACHE = 0x03,
    NAND_OPCODE_WRITE_ENABLE = 0x06,
    NAND_OPCODE_BLOCK_ERASE = 0xd8,
    NAND_OPCODE_PROGRAM_LOAD = 0x02,
    NAND_OPCODE_PROGRAM_EXEC = 0x10,
    NAND_OPCODE_RESET = 0xff,
};
